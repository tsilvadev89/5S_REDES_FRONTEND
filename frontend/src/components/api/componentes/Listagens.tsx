                            ...
                            <div className="row">
                                <div className="">
                                    <ul className="tabs-swipe-demo tabs tabsConsumo ">
                                        <li className="tab col s12"><a href="#2" style={{color: 'black', fontSize: '16px'}}><h5>Cliente <>{item.nome}</></h5></a></li>
                                    </ul>
                                </div>
                                    ...
                                    <form>
                                        ...
                                        <div className="col s2">
                                                <button className="btn waves-effect waves-light"type="submit" name="action" 
                                                    onClick={(e) => this.excluirLocal(cliente['id'], e)}>Excluir<i className="material-icons right">delete</i>
                                                </button>
                                        </div>
                                    </form>
                                </div>
