  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="sm">
      <Card>
        ...
        <CardActions>
          <Button variant="contained" color="primary" onClick={() => setConfirmUpdateOpen(true)}>Atualizar</Button>
          <Button startIcon={<DeleteIcon />} color="error" onClick={() => setConfirmDeleteOpen(true)}>Excluir</Button>
      ...
      <Dialog open={confirmDeleteOpen} onClose={() => setConfirmDeleteOpen(false)}>
        ...
        <DialogActions>
          ...
          <Button onClick={handleDeleteClick} color="error">Confirmar</Button>
        </DialogActions>
      </Dialog>
      ...
      <Snackbar open={copySuccess} autoHideDuration={3000} onClose={() => setCopySuccess(false)}>
        <Alert onClose={() => setCopySuccess(false)} severity="success">Detalhes copiados para a área de transferência!</Alert>
      </Snackbar>
    </Dialog>
  );
};
